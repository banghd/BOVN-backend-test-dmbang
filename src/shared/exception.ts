...
const traverseErrors = (errors: ValidationError[], prefix = ''): ISubError[] => _.compact(
...
export const transformValidationErrors = (errors: ValidationError[]): Exception => new Exception({
  statusCode: HttpStatus.BAD_REQUEST,
